    ...
    <div className={css.containerFeatures}>
      <div className={css.containerDetails}>
        <ul className={css.detailsList}>
              ...
              <li className={css.detailsItem}><SvgIcon width="20" height="20" icon="airConditioner" /><span className={css.detailText}>{catalog.details.airConditioner } air conditioner</span></li>
              <li className={css.detailsItem}><SvgIcon width="20" height="20" icon="cd" /><span className={css.detailText}>CD</span></li>
              <li className={css.detailsItem}><SvgIcon width="20" height="20" icon="radio" /><span className={css.detailText}>Radio</span></li>
          <li className={css.detailsItem}><SvgIcon width="20" height="20" icon="hob" /><span className={css.detailText}>{catalog.details.hob } hob</span></li>
        </ul>
      </div>
